...
# Using a .env.example file to retrieve the phone numbers and tokens.
...
class NotificationManager:
    ...
    def send_sms(self, message_body):
        ...
        your environment (.env.example file) and correspond with numbers registered and verified in your
        Twilio account.
