...
class FlightSearch:
    ...
    def __init__(self):
        ...
        Instance Variables:
        _api_key (str): The API key for authenticating with Amadeus, sourced from the .env.example file
        _api_secret (str): The API secret for authenticating with Amadeus, sourced from the .env.example file.
